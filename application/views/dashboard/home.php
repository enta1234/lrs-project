...
<head>
	...
	<title>DashBoard</title>
  	...
  	<link rel="stylesheet" href="<?php echo base_url('assets/dashboard/'); ?>css/bootstrap.css">
  	<!-- Font Awesome -->
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="<?php echo base_url('assets/dashboard/'); ?>images/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php echo base_url('assets/dashboard/'); ?>images/user2-160x160.jpg" class="user-image" alt="User Image">
